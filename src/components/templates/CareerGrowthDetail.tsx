...
export function CareerGrowthDetail({ rawCareerGrowth, bubbles, _triggerWidget }: CareerGrowthDetailProps) {
  ...
  const handleBubbleSelect = useCallback((option: BubbleOption) => {
    ...
    if (normalizedLabel.includes("view career growth") || 
        normalizedLabel.includes("view career") ||
        normalizedLabel.includes("full career") ||
        normalizedLabel.includes("detailed career") ||
        normalizedLabel.includes("career growth details") ||
        normalizedLabel.includes("open career growth") ||
        normalizedLabel.includes("show career growth") ||
        (normalizedLabel.includes("view") && normalizedLabel.includes("career")) ||
        (normalizedLabel.includes("view") && normalizedLabel.includes("growth"))) {
  ...
  const onVoiceBubbleTranscript = useCallback(
    (transcript: string) => {
      ...
      if (!match && activeWidget === 2) {
        if (normalized.includes("view career growth") || 
            normalized.includes("view career") ||
            normalized.includes("full career") ||
            normalized.includes("detailed career") ||
            normalized.includes("career growth details") ||
            normalized.includes("open career growth") ||
            normalized.includes("show career growth") ||
            (normalized.includes("view") && normalized.includes("career")) ||
            (normalized.includes("view") && normalized.includes("growth"))) {
