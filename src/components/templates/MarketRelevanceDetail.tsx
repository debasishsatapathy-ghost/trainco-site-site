...
export function MarketRelevanceDetail({ rawMarketRelevance, bubbles: bubblesRaw, _triggerWidget }: MarketRelevanceDetailProps) {
  ...
  const handleBubbleSelect = useCallback((option: BubbleOption) => {
    ...
    if (normalizedLabel.includes("view market relevance") || 
        normalizedLabel.includes("view market") ||
        normalizedLabel.includes("full market") ||
        normalizedLabel.includes("detailed market") ||
        normalizedLabel.includes("market relevance details") ||
        normalizedLabel.includes("open market relevance") ||
        normalizedLabel.includes("show market relevance") ||
        (normalizedLabel.includes("view") && normalizedLabel.includes("market")) ||
        (normalizedLabel.includes("view") && normalizedLabel.includes("relevance"))) {
  ...
  const onVoiceBubbleTranscript = useCallback(
    (transcript: string) => {
      ...
      if (!match && activeWidget === 2) {
        if (normalized.includes("view market relevance") || 
            normalized.includes("view market") ||
            normalized.includes("full market") ||
            normalized.includes("detailed market") ||
            normalized.includes("market relevance details") ||
            normalized.includes("open market relevance") ||
            normalized.includes("show market relevance") ||
            (normalized.includes("view") && normalized.includes("market")) ||
            (normalized.includes("view") && normalized.includes("relevance"))) {
