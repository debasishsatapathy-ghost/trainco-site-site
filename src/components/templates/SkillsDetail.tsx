...
export function SkillsDetail({
  ...
  const coverage = overrideCoverage ?? computed.skillCoverage ?? 73;
  ...
  const handleBubbleSelect = useCallback((option: BubbleOption) => {
    ...
    if (normalizedLabel.includes("view skill coverage") || 
        normalizedLabel.includes("view skill") ||
        normalizedLabel.includes("full skill") ||
        normalizedLabel.includes("detailed skill") ||
        normalizedLabel.includes("skill coverage details") ||
        normalizedLabel.includes("open skill coverage") ||
        normalizedLabel.includes("show skill coverage") ||
        (normalizedLabel.includes("view") && normalizedLabel.includes("skill")) ||
        (normalizedLabel.includes("view") && normalizedLabel.includes("coverage"))) {
  ...
  const onVoiceBubbleTranscript = useCallback(
    (transcript: string) => {
      ...
      if (!match && activeWidget === 2) {
        if (normalized.includes("view skill coverage") || 
            normalized.includes("view skill") ||
            normalized.includes("full skill") ||
            normalized.includes("detailed skill") ||
            normalized.includes("skill coverage details") ||
            normalized.includes("open skill coverage") ||
            normalized.includes("show skill coverage") ||
            (normalized.includes("view") && normalized.includes("skill")) ||
            (normalized.includes("view") && normalized.includes("coverage"))) {
